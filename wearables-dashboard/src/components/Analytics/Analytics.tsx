...
export default function Analytics() {
  ...
  return (
    <>
      ...
      {hasStepsData && (
        <Grid item sm={hasSleepData ? 6 : 12} xs={12}>
          <LuzmoVizItemComponent
      ...
      {hasSleepData && (
        <>
          ...
          <Grid item sm={hasStepsData ? 6 : 12} xs={12}>
            <LuzmoVizItemComponent
              options={applyTheme(numberWidgetOptions)}
              slots={numberWidgetSlots}
              type="evolution-number"
              style={LUZMO_VIZ_ITEM_SMALL_STYLE}
              contextId="evolution-number-sleep"
              filters={filtersToApply}
            ></LuzmoVizItemComponent>
          </Grid>
          {/* Create sleep timeline */}
          <Grid item sm={4} xs={12} sx={LUZMO_VIZ_ITEM_LARGE_STYLE}>
            <SleepTimeline />
          </Grid>
        ...
        <>
          ...
          <Grid item sm={12} xs={12}>
            ...
            <LuzmoVizItemComponent
              ...
              type="line-chart"
              style={LUZMO_VIZ_ITEM_LARGE_STYLE}
              contextId="line-chart-steps-movement"
              canFilter="all"
              filters={filtersToApply}
            ></LuzmoVizItemComponent>
          </Grid>
