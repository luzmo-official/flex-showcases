...
@Component({
  selector: 'app-head-to-head-countries-team',
  standalone: true,
  imports: [MetricSelectorComponent, NumberMetricsComponent],
  templateUrl: './head-to-head-countries-team.component.html',
  styleUrl: './head-to-head-countries-team.component.scss',
})
export class HeadToHeadCountriesTeamComponent {
  ...
  metrics: ChartListItem[] = [
    ...
    },
    {
      ...
      class: 'dim-3-5',
      chart: CreateBarChart('marketValue', 'marketValue'),
    },
    {
      key: 'eaSportsFCScore',
      title: 'EA Sports FC 24 score',
      class: 'dim-3-5',
      chart: CreateBarChart('eaProfiles', 'overallScore'),
    },
    {
      key: 'goals',
      title: 'Goals',
    ...
    //{ key: 'attempts', title: 'Attempts', class:"dim-3-4", chart: CreatePlayersStackedBarChart(['attemptsOnTarget', 'attemptsOffTarget', 'attemptsBlocked'], 'sum', [], 'attempts', { mode: 'stacked', bars: { label: 'absolute' } }) },
    {
      key: 'attemptAccuracy',
    ...
    },
    {
      ...
      title: 'Squad age',
      class: 'dim-1-1',
      chart: CreateBarChart('squad', 'age'),
    },
    {
      key: 'height',
      title: 'Height',
